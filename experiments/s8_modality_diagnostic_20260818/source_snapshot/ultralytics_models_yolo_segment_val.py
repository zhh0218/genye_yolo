...
class SegmentationValidator(DetectionValidator):
    ...
    def __init__(self, dataloader=None, depth_test_loader=None, save_dir=None, args=None, _callbacks=None) -> None:
        ...
        Args:
            ...
            depth_test_loader  (torch.utils.data.DataLoader, optional): depth_Dataloader to use for validation.
    ...
    def postprocess(self, preds: list[torch.Tensor]) -> list[dict[str, torch.Tensor]]:
        ...
        """
        if self.end2end:
            proto = preds[0][1]  # end2end: preds = ((y_out, proto), loss_dict)
            preds = super().postprocess(preds[0][0])
        else:
            proto = (
