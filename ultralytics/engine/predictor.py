...
class BasePredictor:
    ...
    def inference(self, im: torch.Tensor,imd: torch.Tensor, *args, **kwargs):
        ...
        return self.model(im, imd, augment=self.args.augment, visualize=visualize, embed=self.args.embed, *args, **kwargs)
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        with self._lock:  # for thread-safe inference
            ...
            for self.batch in self.dataset:
                ...
                # Inference
                with profilers[1]:
                    preds = self.inference(im, None, *args, **kwargs)
                    if self.args.embed:
